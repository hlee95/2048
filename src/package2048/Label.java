...
public class Label extends JLabel{
	...
	static Color [] allColors = new Color [5832];
	...
	static String [] cupcakeFiles = {"blank.jpeg", "carrot.jpeg", "cherry_blossom.jpeg", "milk_chocolate_birthday.jpeg", "chocolate_mint_fudge.jpeg", 
			...
			"lemon_blossom.jpeg", "red_velvet.jpeg", "strawberry_cheesecake.jpeg", "salted_caramel.jpeg"};		
	static ImageIcon [] cupcakeIcons = new ImageIcon[12];
	...
	public void setLabelRandom(int num) {
		...
		if (num!=0)
			index = log(num);
		setBackground(allColors[randInt(0,5831)]);
		setText(numbers[index]);
	}
